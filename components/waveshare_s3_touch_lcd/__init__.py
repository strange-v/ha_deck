...
async def to_code(config):
    ...
    cg.add_library("kylix-rd/ESP32_IO_Expander", "^0.0.3", "https://github.com/kylix-rd/ESP32_IO_Expander.git#v0.0.3")
    cg.add_library("kylix-rd/ESP32_Display_Panel", "^0.0.2", "https://github.com/kylix-rd/ESP32_Display_Panel.git#v0.0.2")

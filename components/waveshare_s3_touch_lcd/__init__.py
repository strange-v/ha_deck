...
async def to_code(config):
    ...
    cg.add_library("lzw655/ESP32_IO_Expander=https://github.com/kylix-rd/ESP32_IO_Expander.git", "^0.0.3")
    cg.add_library("lzw655/ESP32_Display_Panel=https://github.com/kylix-rd/ESP32_Display_Panel.git", "^0.0.2")
